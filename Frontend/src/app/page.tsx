...
function loadAnnotations(
  ...
  fetch(
    `http://localhost:4000/api/v1/get-annotation?imageId=${encodeURIComponent(
      fileName
    )}`
  )
    .then((res) => res.json())
    .then((result) => {
      ...
      // result.data is now an array of annotations from the backend
      ...
      annotations.forEach((ann: any) => {
        ...
        console.log("🚀 ~ loadAnnotations ~ splineInstance:", splineInstance);
...
const DicomViewer: React.FC = () => {
  ...
  const saveAnnotations = () => {
    try {
      ...
      fetch("http://localhost:4000/api/v1/add-annotation", {
        method: "POST",
        headers: {
